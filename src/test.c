...
//   char a[255] = "()";
//   double res = proverka(a);
//   ck_assert_double_eq(res, 0, 1e-6);
// }
// END_TEST
...
//   char a[255] = "2.33mod1";
//   double res = proverka(a);
//   ck_assert_double_eq(res, 0.33, 1e-6);
// }
// END_TEST
